<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("wsoutput");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid wsoutput");
							myInputs[j].focus();
							return false;
						}
					j++;
...
<div id="container">
	<div id="header">
		New Process Instance: /Recovery/src/main/resources/com/redhat/demos/recovery.ordersProcessing
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<label for="name">wsoutput</label>
                            		<div class="div_texbox">
                              		<input name="wsoutput" type="text" class="textbox" id="wsoutput" value="" />
                            		</div>
